...
<div class="formbody">
    ...
    <div style="border: 0px red solid;">
        <form action="saveOrder" method="post" id="myform">
            ...
            <table class="tablelist1" id="orderDetailID">
                <tr>
                    ...
                    <td class="td2">备注</td>
                    <td align="center"><img  src="../images/t01.png" id="mytab1" style="width: 20px;height: 20px;"></td>
                </tr>
                <tr class="mytr" >
                    ...
                    <td align="center"><img class="mytab2" onclick="removeTr(this)"  src="../images/t03.png" style="width: 20px;height: 20px;"></td>
                </tr>
            </table>
